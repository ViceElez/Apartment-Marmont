...
const APARTMENTS = [
    ...
    },
    {
        ...
        description:
            "Perched above the shimmering Adriatic, Apartment Solta blends centuries-old Dalmatian stone with considered contemporary interiors. Open terraces, lavender-scented gardens, and uninterrupted sea views await.",
        ...
        <section className={styles.hero}>
            <div className={styles.backgroundLayer}>
                {prev && (
                    <div
                        key={`prev-${prev.id}`}
                        className={`${styles.bgSlide} ${styles.bgSlideOut}`}
                    >
                        <Image
                            src={prev.image}
                            alt={prev.imageAlt}
                ...
                <div
                    key={`curr-${current.id}`}
                    className={`${styles.bgSlide} ${styles.bgSlideIn}`}
                >
                    <Image
                        src={current.image}
            ...
            <div className={styles.grid}>
                ...
                <div className={styles.reviewsCol}>
                    ...
                    >
                        ...
                        >
                            <span className={styles.reviewsButtonLabel}>
                                Our Reviews
                            </span>
