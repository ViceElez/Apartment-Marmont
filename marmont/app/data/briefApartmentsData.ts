...
export const apartments: Apartment[] = [
    {
        ...
        accent: "#C9A96E",
        rooms: [
            { label: "Living Room", img: "/images/split/general/soba_kroz_vrata.webp", note: "Open-plan with panoramic sea views" },
            { label: "Bedroom", img: "/images/split/general/marmont_teraca1.webp", note: "King bed, linen drapes, private terrace" },
            { label: "Kitchen", img: "/images/split/livingRoom/livingRoom1.webp", note: "Fully equipped, stone countertops" },
        ],
    },
    {
        id: "apt-2",
        ...
        accent: "#8BAAB5",
        rooms: [
            { label: "Living Room", img: "/images/solta/general/img1.webp", note: "Vaulted ceilings, designer furnishings" },
            { label: "Master Suite", img: "/images/solta/general/img4.webp", note: "Ensuite marble bath, infinity views" },
            { label: "Terrace", img: "/images/solta/bedroom/img1.webp", note: "Outdoor dining, plunge pool" },
        ],
    },
];